def create_multiplication_table_v_1(first_multiplier, last_multiplier):
    table = []
...
def create_multiplication_table_v_2(first_multiplier, last_multiplier):
...
def print_multiplication_table(table):
    max_width = len(str(len(table)*len(table)))
...
multiplication_table = create_multiplication_table_v_1(start_number, end_number)
print_multiplication_table(multiplication_table)

multiplication_table = create_multiplication_table_v_2(start_number, end_number)
print_multiplication_table(multiplication_table)
